...
program:
  build-instructions:
    ...
    - command: ./build.sh /experiment
      directory: $setup_dir_path
    steps-for-coverage:
    - command: CFLAGS="--coverage -fsanitize-recover=all -fno-sanitize=null" CPPFLAGS="--coverage -fsanitize-recover=all -fno-sanitize=null"  LDFLAGS="--coverage -fsanitize-recover=all -fno-sanitize=null" ./config.sh /experiment
      directory: $setup_dir_path
    - command: CFLAGS="--coverage -fsanitize-recover=all -fno-sanitize=null" CPPFLAGS="--coverage -fsanitize-recover=all -fno-sanitize=null" LDFLAGS="--coverage -fsanitize-recover=all -fno-sanitize=null" ./build.sh /experiment
      directory: $setup_dir_path
    time-limit: 30
  image: $tag_id
  language: c
