...
PROJECT_CFLAGS="-fsanitize=address -ggdb -Wno-error -O0 -fPIE"
PROJECT_CXXFLAGS="-fsanitize=address -ggdb -Wno-error -O0 -fPIE"
PROJECT_LDFLAGS=" -fsanitize=address -Wno-error -O0 -pie"
