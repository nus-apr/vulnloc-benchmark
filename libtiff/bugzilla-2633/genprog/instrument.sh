...
echo "tools/tiff2ps.c" > $dir_name/manifest.txt

cd $dir_name/src
make clean
make distclean
CC="cilly --save-temps -std=c99 -fno-optimize-sibling-calls -fno-strict-aliasing -fno-asm" ./configure
make --ignore-errors CC="cilly --save-temps -std=c99 -fno-optimize-sibling-calls -fno-strict-aliasing -fno-asm" -j`nproc` CFLAGS="-fPIC" CXXFLAGS="-fPIC"
